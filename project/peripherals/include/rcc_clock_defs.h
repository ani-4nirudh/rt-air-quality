 ...
 *
 * This file contains macros for enabling/disabling the peripheral clocks on a STM32 MCU.
 * Before using any kind of interface (UART, I2C, ADC, USART or Timer), you must first provide that interface with a clock.
 */
